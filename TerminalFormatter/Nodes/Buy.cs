  ...
  public class Buy : TerminalFormatterNode
  {
    ...
    public override string GetNodeText(TerminalNode node, Terminal terminal)
    {
      ...
      if (node.buyItemIndex >= 0)
      {
        ...
        {
          table.AddRow("DISCOUNT:", $"{100 - terminal.itemSalesPercentages[node.buyItemIndex]}%");
        }
      }
      ...
      table.AddRow("TOTAL: ", $"${terminal.totalCostOfItems}  (${terminal.groupCredits - terminal.totalCostOfItems} after purchase)");
